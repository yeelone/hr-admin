...
export class ProfileEditorComponent implements OnInit {
  ...
  ngOnChanges(changes: SimpleChanges): void { 
    ...
    if ( changes.profile.currentValue.on_board_date !== "Invalid date"){
      console.log("changes.profile.currentValue.on_board_date", changes.profile.currentValue.on_board_date )
    ...
    if ( changes.profile.currentValue.birth_day !== "Invalid date"){
      console.log("changes.profile.currentValue.birth_day", changes.profile.currentValue.birth_day )
